    ...
    <div class="py-12 px-6 bg-slate-50 min-h-screen">
        <div class="max-w-4xl mx-auto">
            ...
            <form action="{{ route('admin.atur-form.simpan', $desa->id) }}" method="POST">
                ...
                <div class="space-y-6">
                    ...
                    <div class="bg-white rounded-[2rem] shadow-sm border border-slate-100 overflow-hidden">
                        ...
                        <div class="px-8 py-6 grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <label class="flex items-center p-4 bg-slate-50 rounded-2xl border border-transparent hover:border-blue-100 hover:bg-blue-50/50 transition-all cursor-pointer group">
                                ...
                                <div class="ml-4">
                                    <span class="block text-[11px] font-black text-slate-700 uppercase italic leading-tight group-hover:text-[#1e3a8a]">{{ $indicator->name }}</span>
                                    <span class="block text-[9px] text-slate-400 font-bold uppercase tracking-widest mt-0.5">{{ $indicator->unit }}</span>
                                </div>
                            </label>
                            @endforeach
                        </div>
                ...
                <div class="fixed bottom-10 left-1/2 -translate-x-1/2 w-full max-w-4xl px-6">
