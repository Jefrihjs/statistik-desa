                ...
                @foreach([
                    ...
                    <div class="bg-white rounded-2xl p-5 shadow-sm border border-slate-200 flex items-center gap-4">
                        ...
                        <div class="text-left truncate">
                            ...
                            @if(isset($card['desc']))
                                <span class="text-[9px] text-slate-400 block mt-0.5 truncate uppercase font-bold">{{ $card['desc'] }}</span>
                            @endif
                        </div>
                    </div>
                @endforeach
